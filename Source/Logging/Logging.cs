...
internal class Logger
{
    ...
    /// <summary>
    /// The name of error logs generated by this.
    /// </summary>
    ...
    /// The name of error logs generated by this.
    /// </summary>
    public string ErrLogName => _errLogName;
    ...
    /// </example>
    /// </summary>
    public Logger(string programName = Constants.DefaultFileName, bool printOutput = false, bool debug = false)
    {
        ...
        _logName = $"{_programName}-{_startTime}.log";
        _errLogName = $"Err-{_programName}-{_startTime}.log";
    }
    ...
    private void _Add(string message)
    {
        ...
        using (StreamWriter writer = File.AppendText($"./logs/{LogName}"))
        {
            writer.WriteLine(m);
        }
    ...
    {   
        ...
        using (StreamWriter writer = File.AppendText($"./logs/errs/{ErrLogName}"))
        {
            writer.WriteLine(m);
